            ...
            <div class="form-group">
                ...
                @foreach(App\Client::APPLICATION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('application') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="application_{{ $key }}" name="application" value="{{ $key }}" {{ old('application', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Client::ADDED_BY_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('added_by') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="added_by_{{ $key }}" name="added_by" value="{{ $key }}" {{ old('added_by', '') === (string) $key ? 'checked' : '' }} required>
